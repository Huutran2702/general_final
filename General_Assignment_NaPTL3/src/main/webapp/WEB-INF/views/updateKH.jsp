            ...
            <div class="col-10 content">
                ...
                <div class="row justify-content-center">
                    <div class="card w-100 " style="background-color: transparent">
                        <div class="card-header text-center">Cập nhật khách hàng</div>
                        <div class="card-body d-flex justify-content-center">
                            <form:form class=" w-50 " id="formKhachHang" action="submit" method="post" modelAttribute="khachhang">
                                <div class="form-group">
                                    <label for="maKH">Mã Khách Hàng</label>
                                    <form:input type="text" class="form-control" path="maKH"
                                        aria-describedby="maKH" placeholder="Ma Khach Hang" readonly="true" />
                                    <small id="textMaKH" class="text-danger"></small>
                                </div>
                                <div class="form-group">
                                    <label for="tenKH">Tên Khách Hàng</label>
                                    <form:input type="text" class="form-control" path="tenKH"
                                ...
                                <div class="form-group">
                                    ...
                                    <form:input type="text" class="form-control" path="diaChiEmail"
