			...
			<div class="col-10 content">
				...
				<div class="row justify-content-center">
					<div class="card w-100 " style="background-color: transparent">
						...
						<div class="card-body d-flex justify-content-center">
							<table class="table">
								...
								<tbody>
									<c:forEach items="${listDichVu}" var="dv" varStatus="loop">
										<tr>
											...
											<td>${dv.donGia}</td>
											<td>
												<a class="btn edit" href="edit/${ dv.maDV}">
													<i class="fas fa-edit"></i>
												</a>
												<a class="btn delete" href="delete/${ dv.maDV}">
					...
					<nav aria-label="Page navigation example">
						<ul class="pagination">
							<li class="page-item"><a class="page-link" href="?${key }pageNo=${pre }">Previous</a></li>
							<c:forEach var = "i" begin="1" end="${totalPage }" step="1">
							<li class="page-item"><a class="page-link" href="?${key }pageNo=${i-1 }"><c:out value = "${i}"/></a></li>
							</c:forEach>
							
							
							<li class="page-item"><a class="page-link" href="?${key }pageNo=${next }">Next</a></li>
						</ul>
					</nav>
				</div>
