            ...
            <div class="col-10 content">
                ...
                <div class="row justify-content-center">
                    <div class="card w-100 " style="background-color: transparent">
                        <div class="card-header text-center" >Tạo mới dịch vụ</div>
                        <div class="card-body d-flex justify-content-center">
                            <form:form modelAttribute="dichVu" action="taomoi" method="post" class=" w-50 " id="formDichVu">
                                <div class="form-group">
                                  <label for="maDV">Mã Dịch Vụ</label>
                                  <form:input type="text" class="form-control" path="maDV" aria-describedby="maDV" placeholder="Ma Dich Vu"/>
