            ...
            <div class="col-10 content">
                ...
                <div class="row justify-content-center">
                    <div class="card w-100 " style="background-color: transparent">
                        <div class="card-header text-center">Cập nhật máy</div>
                        <div class="card-body d-flex justify-content-center">
                            <form:form class=" w-50 " id="formMaMay" action="submit" method="post" modelAttribute="may">
                                <div class="form-group">
                                    <label for="maMay">Mã máy</label>
                                    <form:input type="text" class="form-control"  aria-describedby="maMay"
                                        placeholder="Ma May Moi" path="maMay" readonly="true"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <form:select class="form-control" path="trangThai">
                                        <form:option value="Rãnh"/>Rãnh
                                        <form:option value="Bận"/>Bận
                                        <form:option value="Dùng được"/>Dùng được
                                        <form:option value="Đang sửa chữa"/>Đang sửa chữa
                                    </form:select>
